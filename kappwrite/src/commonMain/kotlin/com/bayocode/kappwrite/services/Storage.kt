...
import com.bayocode.kappwrite.enums.ImageFormat
import com.bayocode.kappwrite.enums.ImageGravity
import com.bayocode.kappwrite.models.File
import com.bayocode.kappwrite.models.FileList
...
class Storage(client: Client) : Service(client) {
    ...
    suspend fun createFile(
        ...
        return client.chunkedUpload(
            path = apiPath,
            headers = apiHeaders,
            params = apiParams.filterValues { it != null }.mapValues { it.value!! }.toMutableMap(),
            responseType = ResponseType.Json,
            paramName = paramName,
